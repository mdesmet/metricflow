...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_12.average_booking_value AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_12.max_booking_value, 0) AS Nullable(DOUBLE PRECISION)) AS instant_booking_fraction_of_max_value
  FROM (
