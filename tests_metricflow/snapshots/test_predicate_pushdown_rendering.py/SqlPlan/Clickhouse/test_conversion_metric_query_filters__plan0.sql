...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_24.__buys AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_24.__visits, 0) AS Nullable(DOUBLE PRECISION)) AS visit_buy_conversion_rate_7days
  FROM (
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_15.metric_time__day > date_sub(day, 7, subq_18.metric_time__day)
                  )
                )
            ) subq_19
          ) subq_20
