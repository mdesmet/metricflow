...
FROM (
  ...
  FROM (
    ...
    FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , toStartOfMillisecond(CAST(users_ds_source_src_28000.last_profile_edit_ts AS DateTime64(3))) AS last_profile_edit_ts__millisecond
                  ...
                  , toStartOfMillisecond(CAST(users_ds_source_src_28000.last_profile_edit_ts AS DateTime64(3))) AS user__last_profile_edit_ts__millisecond
      ...
      ON
        date_sub(hour, 1, subq_8.metric_time__hour) = subq_4.metric_time__hour
    ) subq_9
  ) subq_10
) subq_11
