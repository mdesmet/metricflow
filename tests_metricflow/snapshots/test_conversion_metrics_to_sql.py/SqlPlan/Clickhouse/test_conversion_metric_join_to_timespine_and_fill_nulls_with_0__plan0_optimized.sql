...
SELECT
  ...
  , CAST(__buys_fill_nulls_with_0_join_to_timespine AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(__visits_fill_nulls_with_0_join_to_timespine, 0) AS Nullable(DOUBLE PRECISION)) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
FROM (
        ...
        ON
          (
            ...
            (
              ...
              sma_28019_cte.metric_time__day > date_sub(day, 7, subq_43.metric_time__day)
            )
          )
      ) subq_44
      GROUP BY
