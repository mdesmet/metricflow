...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_26.__buys_fill_nulls_with_0_join_to_timespine AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_26.__visits_fill_nulls_with_0_join_to_timespine, 0) AS Nullable(DOUBLE PRECISION)) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
  FROM (
                ...
                ON
                  (
                    ...
                    (
                      ...
                      subq_12.metric_time__day > date_sub(day, 7, subq_15.metric_time__day)
                    )
                  )
              ) subq_16
            ) subq_17
