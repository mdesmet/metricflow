...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_16.__buys AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_16.__visits, 0) AS Nullable(DOUBLE PRECISION)) AS visit_buy_conversion_rate_by_session
  FROM (
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_7.metric_time__day > date_sub(day, 7, subq_10.metric_time__day)
                  )
                )
            ) subq_11
          ) subq_12
