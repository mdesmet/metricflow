...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_20.__buys AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_20.__visits, 0) AS Nullable(DOUBLE PRECISION)) AS visit_buy_conversion_rate_7days
  FROM (
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_11.metric_time__day > date_sub(day, 7, subq_14.metric_time__day)
                  )
                )
            ) subq_15
          ) subq_16
