...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_12.booking_value_with_is_instant_constraint AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_12.booking_value, 0) AS Nullable(DOUBLE PRECISION)) AS instant_booking_value_ratio
  FROM (
